...
\subsubsection[{get}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ static \-T {\bf cppcms\-::json\-::traits}$<$ \-T $>$\-::{\bf get} (
...
\-Convert json value {\itshape v\/} to an object of type \-T and return it \index{cppcms\-::json\-::traits@{cppcms\-::json\-::traits}!set@{set}}
\index{set@{set}!cppcms::json::traits@{cppcms\-::json\-::traits}}
\subsubsection[{set}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ static void {\bf cppcms\-::json\-::traits}$<$ \-T $>$\-::{\bf set} (
\begin{DoxyParamCaption}
\item[{{\bf value} \&}]{v, }
\item[{\-T const \&}]{in}
\end{DoxyParamCaption}
