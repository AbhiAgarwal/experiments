...
\subsubsection[{add}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename \-Pointer$>$ void {\bf booster\-::aio\-::buffer\-\_\-impl}$<$ \-Pointer $>$\-::{\bf add} (
\begin{DoxyParamCaption}
\item[{\-Pointer}]{p, }
\item[{size\-\_\-t}]{s}
\end{DoxyParamCaption}
...
\subsubsection[{empty}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename \-Pointer$>$ bool {\bf booster\-::aio\-::buffer\-\_\-impl}$<$ \-Pointer $>$\-::{\bf empty} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename \-Pointer$>$ std\-::pair$<${\bf entry} const $\ast$,size\-\_\-t$>$ {\bf booster\-::aio\-::buffer\-\_\-impl}$<$ \-Pointer $>$\-::{\bf get} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
