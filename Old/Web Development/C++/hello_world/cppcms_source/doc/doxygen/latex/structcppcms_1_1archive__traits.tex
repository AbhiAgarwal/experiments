...
\subsubsection[{load}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Object $>$ static void {\bf cppcms\-::archive\-\_\-traits}$<$ \-Object $>$\-::{\bf load} (
...
\subsubsection[{save}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Object $>$ static void {\bf cppcms\-::archive\-\_\-traits}$<$ \-Object $>$\-::{\bf save} (
\begin{DoxyParamCaption}
\item[{\-Object const \&}]{d, }
\item[{{\bf archive} \&}]{a}
\end{DoxyParamCaption}
