...
)\hspace{0.3cm}{\ttfamily  [inline, protected]}}\label{classbooster_1_1locale_1_1collator_aa12207d0d38e355a80c2374a4a6b8595}
...
\subsubsection[{compare}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ int {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf compare} (
\begin{DoxyParamCaption}
...
\subsubsection[{do\-\_\-compare}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ virtual int {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf do\-\_\-compare} (
\begin{DoxyParamCaption}
\item[{{\bf char\-\_\-type} const $\ast$}]{b1, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e1, }
\item[{{\bf char\-\_\-type} const $\ast$}]{b2, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e2}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [inline, protected, virtual]}}\label{classbooster_1_1locale_1_1collator_a17c522d7978bc89fd412aeb8d7809f04}
...
\item[{{\bf char\-\_\-type} const $\ast$}]{e2}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [protected, pure virtual]}}\label{classbooster_1_1locale_1_1collator_ad8e79f03cdc362a9195eb81a15f626bd}
...
\subsubsection[{do\-\_\-hash}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ virtual long {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf do\-\_\-hash} (
\begin{DoxyParamCaption}
\item[{{\bf char\-\_\-type} const $\ast$}]{b, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [inline, protected, virtual]}}\label{classbooster_1_1locale_1_1collator_ab69f3a6a0e13ae1c1d589e6b5b8f7c6e}
\-This function is used to override default collation function that does not take in account collation level. \-Uses primary level 
...
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [protected, pure virtual]}}\label{classbooster_1_1locale_1_1collator_ae412e2daa978d73472945ef6e9a4f9f4}
...
\subsubsection[{do\-\_\-transform}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ virtual {\bf string\-\_\-type} {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf do\-\_\-transform} (
\begin{DoxyParamCaption}
\item[{{\bf char\-\_\-type} const $\ast$}]{b, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [inline, protected, virtual]}}\label{classbooster_1_1locale_1_1collator_ab03d39b5d1948c53ae755bbc1c6f8908}
\-This function is used to override default collation function that does not take in account collation level. \-Uses primary level 
...
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  [protected, pure virtual]}}\label{classbooster_1_1locale_1_1collator_a6ff91d0873d513db245f6f44f66b6170}
...
\subsubsection[{hash}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ long {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf hash} (
\begin{DoxyParamCaption}
\item[{{\bf level\-\_\-type}}]{level, }
\item[{{\bf char\-\_\-type} const $\ast$}]{b, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
...
\subsubsection[{transform}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ {\bf string\-\_\-type} {\bf booster\-::locale\-::collator}$<$ \-Char\-Type $>$\-::{\bf transform} (
\begin{DoxyParamCaption}
\item[{{\bf level\-\_\-type}}]{level, }
\item[{{\bf char\-\_\-type} const $\ast$}]{b, }
\item[{{\bf char\-\_\-type} const $\ast$}]{e}
...
\begin{DoxyCode}
   compare(level,b1,e1,b2,e2) == sign( transform(level,b1,e1).compare(transform
      (level,b2,e2)) );
\end{DoxyCode}
