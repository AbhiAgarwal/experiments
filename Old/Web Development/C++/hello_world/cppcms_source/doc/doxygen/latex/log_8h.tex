...
struct {\bfseries booster\-::log\-::logger\-::entry}
\item 
...
\subsubsection[{\-B\-O\-O\-S\-T\-E\-R\-\_\-\-L\-O\-G}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf \-B\-O\-O\-S\-T\-E\-R\-\_\-\-L\-O\-G}(
...
{\bfseries \-Value\-:}
\begin{DoxyCode}
::booster::log::logger::instance().should_be_logged(::booster::log::level,
      module)       \
                && ::booster::log::message(::booster::log::level,module,
