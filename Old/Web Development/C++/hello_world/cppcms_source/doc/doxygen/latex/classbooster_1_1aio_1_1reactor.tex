...
\subsubsection[{name}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string {\bf booster\-::aio\-::reactor\-::name} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{poll}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf booster\-::aio\-::reactor\-::poll} (
\begin{DoxyParamCaption}
...
\subsubsection[{remove}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf booster\-::aio\-::reactor\-::remove} (
\begin{DoxyParamCaption}
...
\subsubsection[{select}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf booster\-::aio\-::reactor\-::select} (
\begin{DoxyParamCaption}
\item[{{\bf native\-\_\-type}}]{fd, }
\item[{int}]{flags}
\end{DoxyParamCaption}
