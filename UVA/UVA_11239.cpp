...
We know that there are ~ only 100 individuals in the School
participating in the project so we can put them and point
...
bool maxValue(Project A, Project B){if(A.numberOfStudents > B.numberOfStudents){return true;}else if(A.numberOfStudents < B.numberOfStudents){return false;}else if(A.name < B.name){return true;}return false;}
int main(){
