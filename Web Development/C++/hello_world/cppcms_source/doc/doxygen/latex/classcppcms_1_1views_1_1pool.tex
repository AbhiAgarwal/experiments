...
\subsubsection[{add}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::views\-::pool\-::add} (
...
\subsubsection[{enumerate}]{\setlength{\rightskip}{0pt plus 5cm}std\-::vector$<$std\-::string$>$ {\bf cppcms\-::views\-::pool\-::enumerate} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{instance}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf pool}\& {\bf cppcms\-::views\-::pool\-::instance} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{remove}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::views\-::pool\-::remove} (
\begin{DoxyParamCaption}
\item[{{\bf generator} const \&}]{generator}
\end{DoxyParamCaption}
...
\subsubsection[{render}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::views\-::pool\-::render} (
\begin{DoxyParamCaption}
