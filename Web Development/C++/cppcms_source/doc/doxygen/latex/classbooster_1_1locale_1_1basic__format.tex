...
\begin{DoxyCode}
   cout << format("The height of water at {1,time} is {2,num=fixed,precision=3}
      ") % time % height;
\end{DoxyCode}
...
\begin{DoxyCode}
    cout << format("Today {1,date}
       ({1,date,locale=he_IL.UTF-8@calendar=hebrew,date} Hebrew Date)") % date;
\end{DoxyCode}

\item {\ttfamily timezone} or {\ttfamily tz} -\/-\/ the name of the timezone to display the time in. \-For example\-:\par
 
\begin{DoxyCode}
    cout << format("Time is: Local {1,time}, ({1,time,tz=EET} Eastern European
       Time)") % date;
\end{DoxyCode}
...
\begin{DoxyCode}
    cout << format("Local time is: {1,time,local}, universal time is
       {1,time,gmt}") % time;
\end{DoxyCode}
...
\-The translation message type \index{booster\-::locale\-::basic\-\_\-format@{booster\-::locale\-::basic\-\_\-format}!string\-\_\-type@{string\-\_\-type}}
\index{string\-\_\-type@{string\-\_\-type}!booster::locale::basic_format@{booster\-::locale\-::basic\-\_\-format}}
\subsubsection[{string\-\_\-type}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ typedef std\-::basic\-\_\-string$<$\-Char\-Type$>$ {\bf booster\-::locale\-::basic\-\_\-format}$<$ \-Char\-Type $>$\-::{\bf string\-\_\-type}}\label{classbooster_1_1locale_1_1basic__format_a591c3a0ed5134105230987e4f6017a18}
...
\subsubsection[{str}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ {\bf string\-\_\-type} {\bf booster\-::locale\-::basic\-\_\-format}$<$ \-Char\-Type $>$\-::{\bf str} (
\begin{DoxyParamCaption}
...
\subsubsection[{write}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Char\-Type $>$ void {\bf booster\-::locale\-::basic\-\_\-format}$<$ \-Char\-Type $>$\-::{\bf write} (
\begin{DoxyParamCaption}
