...
1. \-All hierarchy share the counter of the topmost application. \-Thus, when all bundle is counted as a single unit allowing passing intrusive\-\_\-ptr to itself to the central service safely. \-When the topmost application is destroyed, it destroys all its children application classes. 2. \-When reference count goes to 0, the application is not destroyed but rather recycled to the application pool for future use. 3. \-The above hold only for synchronous applications, asynchronous one are destroyed when all reference count goes to 0.

\-There two ways to add sub-\/applications to hierarchy\-:

1. \-Using member function family {\itshape add\/}, usually used with direct members of the parent class. \-Such child are not destroyed explicitly. 2. \-Using member function family {\itshape attach\/}. \-The ownership on the application is moved to the parent class and it destroys an attached class with delete. 
...
\subsubsection[{application}]{\setlength{\rightskip}{0pt plus 5cm}{\bf cppcms\-::application\-::application} (
...
\subsubsection[{$\sim$application}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf cppcms\-::application\-::$\sim$application} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{add}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::application\-::add} (
\begin{DoxyParamCaption}
...
\subsubsection[{assign\-\_\-context}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::application\-::assign\-\_\-context} (
\begin{DoxyParamCaption}
...
\subsubsection[{attach}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::application\-::attach} (
\begin{DoxyParamCaption}
...
\-Ownership of app is transfered to parent. \index{cppcms\-::application@{cppcms\-::application}!cache@{cache}}
\index{cache@{cache}!cppcms::application@{cppcms\-::application}}
\subsubsection[{cache}]{\setlength{\rightskip}{0pt plus 5cm}{\bf cache\-\_\-interface}\& {\bf cppcms\-::application\-::cache} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{clear}]{\setlength{\rightskip}{0pt plus 5cm}virtual void {\bf cppcms\-::application\-::clear} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{context}]{\setlength{\rightskip}{0pt plus 5cm}{\bf http\-::context}\& {\bf cppcms\-::application\-::context} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{dispatcher}]{\setlength{\rightskip}{0pt plus 5cm}{\bf url\-\_\-dispatcher}\& {\bf cppcms\-::application\-::dispatcher} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\-\_\-context}]{\setlength{\rightskip}{0pt plus 5cm}{\bf booster\-::shared\-\_\-ptr}$<${\bf http\-::context}$>$ {\bf cppcms\-::application\-::get\-\_\-context} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{init}]{\setlength{\rightskip}{0pt plus 5cm}virtual void {\bf cppcms\-::application\-::init} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{is\-\_\-asynchronous}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf cppcms\-::application\-::is\-\_\-asynchronous} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{main}]{\setlength{\rightskip}{0pt plus 5cm}virtual void {\bf cppcms\-::application\-::main} (
\begin{DoxyParamCaption}
\item[{std\-::string}]{url}
\end{DoxyParamCaption}
...
\subsubsection[{mapper}]{\setlength{\rightskip}{0pt plus 5cm}{\bf url\-\_\-mapper}\& {\bf cppcms\-::application\-::mapper} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{parent}]{\setlength{\rightskip}{0pt plus 5cm}{\bf application}$\ast$ {\bf cppcms\-::application\-::parent} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{release\-\_\-context}]{\setlength{\rightskip}{0pt plus 5cm}{\bf booster\-::shared\-\_\-ptr}$<${\bf http\-::context}$>$ {\bf cppcms\-::application\-::release\-\_\-context} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{render}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf cppcms\-::application\-::render} (
\begin{DoxyParamCaption}
...
\subsubsection[{request}]{\setlength{\rightskip}{0pt plus 5cm}{\bf http\-::request}\& {\bf cppcms\-::application\-::request} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{response}]{\setlength{\rightskip}{0pt plus 5cm}{\bf http\-::response}\& {\bf cppcms\-::application\-::response} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{root}]{\setlength{\rightskip}{0pt plus 5cm}{\bf application}$\ast$ {\bf cppcms\-::application\-::root} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{service}]{\setlength{\rightskip}{0pt plus 5cm}{\bf cppcms\-::service}\& {\bf cppcms\-::application\-::service} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{session}]{\setlength{\rightskip}{0pt plus 5cm}{\bf session\-\_\-interface}\& {\bf cppcms\-::application\-::session} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{settings}]{\setlength{\rightskip}{0pt plus 5cm}{\bf json\-::value} const\& {\bf cppcms\-::application\-::settings} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{translate}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string {\bf cppcms\-::application\-::translate} (
\begin{DoxyParamCaption}
...
\subsubsection[{url}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string {\bf cppcms\-::application\-::url} (
\begin{DoxyParamCaption}
