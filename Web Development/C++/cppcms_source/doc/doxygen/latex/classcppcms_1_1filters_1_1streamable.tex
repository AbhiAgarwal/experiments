...
\subsubsection[{get}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ \-T const\& {\bf cppcms\-::filters\-::streamable\-::get} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{get@{get}!cppcms::filters::streamable@{cppcms\-::filters\-::streamable}}
\subsubsection[{get}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string {\bf cppcms\-::filters\-::streamable\-::get} (
\begin{DoxyParamCaption}
\item[{std\-::ios \&}]{ios}
\end{DoxyParamCaption}
